...
export const AnimatedLogo = ({ size = 40, color = "#128C7E" }: AnimatedLogoProps) => {
  ...
  const scale = size / 189 // Original SVG width is 189pt

  return (
    <View style={styles.container}>
      <Animated.View style={{ transform: [{ rotate: spin }] }}>
        <Svg width={size} height={size * (194 / 189)} viewBox="0 0 189 194">
          <G fill={color}>
